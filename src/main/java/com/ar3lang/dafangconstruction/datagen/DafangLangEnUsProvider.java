...
public class DafangLangEnUsProvider extends FabricLanguageProvider {
    ...
    public void generateTranslations(TranslationBuilder translationBuilder) {
        ...
        translationBuilder.add(DafangBlocks.GRANITE_YELLOWRUST_BRICK1,"Yellow Rust Granite Large Brick (Staggered)");
        translationBuilder.add(DafangBlocks.GRANITE_YELLOWRUST_BRICK2,"Yellow Rust Granite Large Brick (x2)");
        translationBuilder.add(DafangBlocks.GRANITE_YELLOWRUST_BRICK3,"Yellow Rust Granite Large Brick (x1.5)");
        translationBuilder.add(DafangBlocks.GRANITE_YELLOWRUST_BRICK4,"Yellow Rust Granite Large Brick (Vertical Grain x2)");
        translationBuilder.add(DafangBlocks.GRANITE_YELLOWRUST_BRICK5,"Yellow Rust Granite Large Brick (Vertical Grain x1.5)");
        ...
        translationBuilder.add(DafangBlocks.GRANITE_RED_BRICK1,"Red-Speckled Granite Large Brick (Staggered)");
        translationBuilder.add(DafangBlocks.GRANITE_RED_BRICK2,"Red-Speckled Granite Large Brick (x2)");
        translationBuilder.add(DafangBlocks.GRANITE_RED_BRICK3,"Red-Speckled Granite Large Brick (x1.5)");
        translationBuilder.add(DafangBlocks.GRANITE_RED_BRICK4,"Red-Speckled Granite Large Brick (Vertical Grain x2)");
        translationBuilder.add(DafangBlocks.GRANITE_RED_BRICK5,"Red-Speckled Granite Large Brick (Vertical Grain x1.5)");
        ...
        translationBuilder.add(DafangBlocks.GRANITE_GRAY_BRICK1,"Gray Granite Large Brick (Staggered)");
        translationBuilder.add(DafangBlocks.GRANITE_GRAY_BRICK_2,"Gray Granite Large Brick (x2)");
        translationBuilder.add(DafangBlocks.GRANITE_GRAY_BRICK3,"Gray Granite Large Brick (x1.5)");
        translationBuilder.add(DafangBlocks.GRANITE_GRAY_BRICK4,"Gray Granite Large Brick (Vertical Grain x2)");
        translationBuilder.add(DafangBlocks.GRANITE_GRAY_BRICK5,"Gray Granite Large Brick (Vertical Grain x1.5)");
