...
public class DafangTextureMetadataProvider extends FusionTextureMetadataProvider {
    ...
    private enum EnumType {
        ...
        RANDOM3(
            DefaultTextureTypes.RANDOM,
            RandomTextureData.builder().rows(3).columns(3).build()
        );
    ...
    private void addTextureMetadata(Block block, EnumType type) {
        super.addTextureMetadata(
            //本类只能注册Dafang的方块mcmeta，写死
            new Identifier(DafangConstruction.MOD_ID, "block/"+Registries.BLOCK.getId(block).getPath()),
            type.textureType,
            type.data
        );
    }
    ...
    protected void generate() {
        ...
        addTextureMetadata(DafangBlocks.GRANITE_YELLOWRUST_BRICK_3, EnumType.PATTERN2);
        ...
        addTextureMetadata(DafangBlocks.GRANITE_RED_BRICK_3, EnumType.PATTERN2);
        ...
        addTextureMetadata(DafangBlocks.GRANITE_GALAXYGRAY_BRICK_3, EnumType.PATTERN2);
        ...
        addTextureMetadata(DafangBlocks.GRANITE_GRAY_BRICK_3, EnumType.PATTERN2);
