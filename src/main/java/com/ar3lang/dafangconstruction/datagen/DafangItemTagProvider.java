...
public class DafangItemTagProvider extends FabricTagProvider.ItemTagProvider {
    public DafangItemTagProvider(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> completableFuture, @Nullable BlockTagProvider blockTagProvider) {
